...
values."
  (setq-default
   ...
   '(
     ...
     ;; (shell :variables
     ;;        shell-default-height 30
     ;;        shell-default-position 'bottom)y
     ;; spell-checking
     ;; syntax-checking
     ;; version-control
     )
